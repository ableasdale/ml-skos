...
<xf:model>
    ...
    {if (string-length(xdmp:get-request-field("id")) gt 1)
    then (<xf:submission id="save" method="put" replace="instance" instance="submit-results" action="/save/{fn:substring-before(xdmp:get-request-field("id"), ".")}" ref="instance('skos')">
    ...
    else (<xf:submission id="save" method="put" replace="instance" instance="submit-results" action="/xquery/skos-concept-submit.xqy" ref="instance('skos')">
        <xf:toggle case="case-busy" ev:event="xforms-submit"></xf:toggle>
        <xf:load ev:event="xforms-submit-done" resource="/" show="replace" /> 
        <!-- XFSubmission.submit() -->
        <!-- <xf:toggle case="case-submit-done" ev:event="xforms-submit-done"></xf:toggle> -->
