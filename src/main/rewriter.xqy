...
if(starts-with($url, "/xml/") or starts-with($url, "/xsltforms/") or starts-with($url, "/css/") or starts-with($url, "/js/") or starts-with($url, "/xquery/search.xqy") or starts-with($url, "/xquery/skos-concept-submit.xqy") or starts-with($url, "/xquery/edit.xqy"))
then $url
else $rewrite
